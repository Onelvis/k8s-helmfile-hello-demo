...
{{/*
Compute a checksum of the secret value.
This forces a new rollout when .Values.azureVaultSecret changes.
*/}}
{{- define "hello.secretChecksum" -}}
{{- printf "%s" (sha256sum .Values.azureVaultSecret) -}}
{{- end -}}
